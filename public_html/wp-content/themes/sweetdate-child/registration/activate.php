    ...
    <?php get_template_part('page-parts/buddypress-before-wrap');?>
		...
		<div id="activate-page">
			...
			<?php if ( bp_account_was_activated() ) : ?>
				...
				<?php if ( isset( $_GET['e'] ) ) : ?>
					<p><?php _e( 'Your account was activated successfully! Your account details have been sent to you in a separate email.', 'buddypress' ); ?> <br/>  <br/> <br/> <br/> <br/> <br/> <br/> <br/> </p>
				<?php else : ?>
					<p><?php _e( 'Your account was activated successfully! You can now log in with the username and password you provided when you signed up.', 'buddypress' ); ?>  <br/>  <br/> <br/> <br/> <br/> <br/> <br/> <br/>    </p>
				<?php endif; ?>
