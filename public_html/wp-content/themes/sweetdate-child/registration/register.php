    ...
    <div id="main">
		...
		<div id="register-page">
						...
						<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
							...
							<div class="editfield">
								...
								<?php if ( 'selectbox' == bp_get_the_profile_field_type() ) : ?>
									...
									<label for="<?php bp_the_profile_field_input_name(); ?>"><?php bp_the_profile_field_name(); ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(required)', 'buddypress' ); ?><?php endif; ?></label>
									<?php do_action( 'bp_' . bp_get_the_profile_field_input_name() . '_errors' ); ?>
									<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>" id="<?php bp_the_profile_field_input_name(); ?>">
								...
								<?php if ( 'multiselectbox' == bp_get_the_profile_field_type() ) : ?>
									...
									<label for="<?php bp_the_profile_field_input_name(); ?>"><?php bp_the_profile_field_name(); ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(required)', 'buddypress' ); ?><?php endif; ?></label>
									<?php do_action( 'bp_' . bp_get_the_profile_field_input_name() . '_errors' ); ?>
									<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>" id="<?php bp_the_profile_field_input_name(); ?>" multiple="multiple">
										<?php bp_the_profile_field_options(); ?>
									</select>
								...
								<?php if ( 'radio' == bp_get_the_profile_field_type() ) : ?>
									...
									<div class="radio">
										<label class="reglabel"><?php bp_the_profile_field_name(); ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(required)', 'buddypress' ); ?><?php endif; ?></label>
								...
								<?php if ( 'datebox' == bp_get_the_profile_field_type() ) : ?>
									...
									<div class="datebox row">
										...
										<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>_day" id="<?php bp_the_profile_field_input_name(); ?>_day">
											<?php bp_the_profile_field_options( 'type=day' ); ?>
										</select>
                                                                            </div>
                                                                            <div class="four columns">
										<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>_month" id="<?php bp_the_profile_field_input_name(); ?>_month">
											<?php bp_the_profile_field_options( 'type=month' ); ?>
										</select>
                                                                            </div>
                                                                            <div class="four columns">
										<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>_year" id="<?php bp_the_profile_field_input_name(); ?>_year">
			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<h2 class="article-title"><?php _e( 'Sign Up Complete!', 'buddypress' ); ?></h2>

				<?php do_action( 'template_notices' ); ?>
				<?php do_action( 'bp_before_registration_confirmed' ); ?>

				<?php if ( bp_registration_needs_activation() ) : ?>
					<p><?php _e( 'You have successfully created your account! To begin using this site you will need to activate your account via the email we have just sent to your address.', 'buddypress' ); ?><p><br/>  <br/> <br/> <br/> <br/> <br/> <br/> </p></p>
				<?php else : ?>
					<p><?php _e( 'You have successfully created your account! Please log in using the username and password you have just created.', 'buddypress' ); ?><p><br/>  <br/> <br/> <br/> <br/> <br/> <br/> </p></p>
				<?php endif; ?>
