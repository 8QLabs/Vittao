...
<div id="header">
    ...
    <div class="four columns">
      <h1 id="logo"><?php bloginfo('name'); ?>
          <a href="<?php echo get_home_url(); ?>"><img id="logo_img" src="<?php echo sq_option('logo',get_template_directory_uri().'/assets/images/logo.png'); ?>" width="400" height="110" alt="<?php bloginfo('name'); ?>"></a>
      </h1>
    </div>
    <!--end logo-->
    ...
    <div class="eight columns">
        ...
        <nav class="top-bar">
          ...
          <section><!-- Nav Section -->
              <?php wp_nav_menu( array( 'container' => false, 'menu_class' => 'right', 'theme_location' => 'primary', 'fallback_cb' => 'sweetdate_main_nav', 'walker' => new sweetdate_walker_nav_menu) ); ?>
...
mixpanel.init("0c1e18fe4c84ad74e7dee7428fde6fd4");</script><!-- end Mixpanel -->
