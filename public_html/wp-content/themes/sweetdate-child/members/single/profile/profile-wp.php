		...
		<table class="wp-profile-fields">
			...
			<?php if ( $ud->display_name ) : ?>
				...
				<tr id="wp_displayname">
					<td class=""><?php _e( 'Name', 'buddypress' ); ?></td>
			...
			<?php if ( $ud->user_description ) : ?>
				...
				<tr id="wp_desc">
					<td class=""><?php _e( 'About Me', 'buddypress' ); ?></td>
			...
			<?php if ( $ud->user_url ) : ?>
				...
				<tr id="wp_website">
					<td class=""><?php _e( 'Website', 'buddypress' ); ?></td>
					<td class="data"><?php echo $ud->user_url; ?></td>
				</tr>
			...
			<?php if ( $ud->jabber ) : ?>
				...
				<tr id="wp_jabber">
					<td class=""><?php _e( 'Jabber', 'buddypress' ); ?></td>
			...
			<?php if ( $ud->aim ) : ?>
				...
				<tr id="wp_aim">
					<td class=""><?php _e( 'AOL Messenger', 'buddypress' ); ?></td>
			...
			<?php if ( $ud->yim ) : ?>
				...
				<tr id="wp_yim">
					<td class=""><?php _e( 'Yahoo Messenger', 'buddypress' ); ?></td>
