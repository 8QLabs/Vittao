...
class SQueen {
    ...
    public function add_typography_css($option)
    {
        ...
        foreach($db_option as $k => $v)
        {
            ...
            {
                add_action( 'wp_enqueue_scripts', create_function( '', "wp_register_style(sanitize_title('$font'), 'http://fonts.googleapis.com/css?family=$font', array(), '', 'all' );wp_enqueue_style( sanitize_title('$font'));" ) );   
            }
