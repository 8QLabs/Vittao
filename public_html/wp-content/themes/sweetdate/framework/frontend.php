...
$kleo_sweetdate->add_css('.form-search, .form-header, div.alert-box {background:'.sq_option('button_bg_color').'}');
...
$kleo_sweetdate->add_css('.form-search.custom div.custom.dropdown a.current, .form-search.custom input[type="text"],.form-search.custom input[type="password"] {background-color: '.sq_option('button_bg_color_hover').'; }.form-search.custom div.custom.dropdown a.selector, .form-search.custom div.custom.dropdown a.current { border: solid 1px '.sq_option('button_bg_color_hover').'; }');
...
//form transparency
$main_color_rgb = hexToRGB(sq_option('button_bg_color_hover'));
...
//Primary Buttons
$kleo_sweetdate->add_css('.button, ul.sub-nav li.current a, #subnav ul li.current a, .wpcf7-submit, #rtmedia-add-media-button-post-update, #rt_media_comment_submit, .rtmedia-container input[type="submit"] { border: 1px solid '.sq_option('button_bg_color').'; background: '.sq_option('button_bg_color').'; color: '.sq_option('button_text_color').'; }');
...
//Secondary Buttons
$kleo_sweetdate->add_css('.button.secondary, #messages_search_submit, #rtmedia-whts-new-upload-button, #rtMedia-upload-button, #rtmedia_create_new_album,#rtmedia-nav-item-albums-li a,#rtmedia-nav-item-photo-profile-1-li a,#rtmedia-nav-item-video-profile-1-li a,#rtmedia-nav-item-music-profile-1-li a { background-color: '.sq_option('button_secondary_bg_color').'; color: '.sq_option('button_secondary_text_color').'; border: 1px solid '.sq_option('button_secondary_bg_color').'; }');
$kleo_sweetdate->add_css('.button.secondary:hover,.button.secondary:focus, #messages_search_submit:hover, #messages_search_submit:focus,  #rtmedia-whts-new-upload-button:hover, #rtMedia-upload-button:hover, #rtmedia_create_new_album:hover,#rtmedia-nav-item-albums-li a:hover,#rtmedia-nav-item-photo-profile-1-li a:hover,#rtmedia-nav-item-video-profile-1-li a:hover,#rtmedia-nav-item-music-profile-1-li a:hover { background-color: '.sq_option('button_secondary_bg_color_hover').';  border: 1px solid '.sq_option('button_secondary_bg_color_hover').'; color: '.sq_option('button_secondary_text_color_hover').'; }');
...
$kleo_sweetdate->add_bg_css('bp_header_background','#profile');
...
if (sq_option('responsive_design') == 1) {
   $kleo_sweetdate->add_css('@media only screen and (max-width: 940px) {.top-bar ul > li:not(.name):hover, .top-bar ul > li:not(.name).active, .top-bar ul > li:not(.name):focus { background: '.sq_option('menu_secondary_color').'; }.top-bar { background: '.sq_option('menu_primary_color').'; }.top-bar > ul .name h1 a { background: '.sq_option('menu_secondary_color').'; }.top-bar ul > li.has-dropdown.moved > .dropdown li a:hover { background: '.sq_option('menu_secondary_color').'; display: block; }.top-bar ul > li.has-dropdown .dropdown li.has-dropdown > a li a:hover, .top-bar ul > li.toggle-topbar { background: '.sq_option('menu_secondary_color').'; }}');
    ...
    $kleo_sweetdate->add_css('.kleo-page {display:inline-block;}');
}
/* -----------------------------------------------------------------------------
 * END Front end style
 */
