...
if (!function_exists('kleo_toggle')) {
    function kleo_toggle( $atts, $content = null ) {
        ...
        return "<div data-id='".$state."' class=\"kleo-toggle\"><span class=\"kleo-toggle-title\">". $title ."</span><div class=\"kleo-toggle-inner\">". do_shortcode($content) ."</div></div>";
    }
...
if (!function_exists('kleo_posts_carousel')) {
    function kleo_posts_carousel( $atts, $content = null ) {
        ...
        $output = '
            <p>
                <span class="right hide-for-small">
                    <a href="#" id="story-prev"><i class="icon-circle-arrow-left icon-large"></i></a>&nbsp;
                    <a href="#" id="story-next"><i class="icon-circle-arrow-right icon-large"></i></a>
                </span>
            </p>
            <div class="carousel-stories responsive">
              <ul id="feature-stories">';
        ...
        endwhile;
        wp_reset_postdata();
        $output .= '</ul></div><!--end carousel-profiles-->';
