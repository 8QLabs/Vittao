...
$kleo_shortcodes['toggle'] = array(
	...
	'shortcode' => '[kleo_toggle title="{{title}}" state="{{state}}"] {{content}} [/kleo_toggle]',
...
$kleo_shortcodes['tabs'] = array(
    'params' => array(),
    'no_preview' => true,
    'shortcode' => '[kleo_tabs] {{child_shortcode}}  [/kleo_tabs]',
...
$kleo_shortcodes['accordion'] = array(
    'params' => array(),
    'no_preview' => true,
    'shortcode' => '[kleo_accordion] {{child_shortcode}}  [/kleo_accordion]',
...
$kleo_shortcodes['call_to_action'] = array(
	...
	'params' => array(
		'bg' => array(
			...
			'type' => 'text',
			'label' => __('Background', 'kleo_framework'),
			'desc' => __('<input rel-id="kleo_bg" type="button" class="sc_upload_image_button" value="Upload"> <br>Change the default background', 'kleo_framework'),
...
$kleo_shortcodes['status_icon'] = array(
    ...
    'child_shortcode' => array(
		...
		'type' => array(
			'type' => 'select',
			'label' => __('Icon type', 'kleo_framework'),
			'desc' => __('Select the icon\'s type', 'kleo_framework'),
			'options' => array(
				'total' => 'Total members',
		...
		'image' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Icon Image', 'kleo_framework'),
			'desc' => '<input type="button" class="sc_upload_image_button" value="Upload"> <br>'.__('Change the icon default image', 'kleo_framework'),
		),
		...
		'subtitle' => array(
			...
			'desc' => __('Add the subtitle text', 'kleo_framework'),
		)
            
        ),
        'shortcode' => '[kleo_status_icon type="{{type}}" image="{{image}}" subtitle="{{subtitle}}"]',
        'clone_button' => __('Add Status Icon', 'kleo_framework')
    )
