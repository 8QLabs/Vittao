		...
		createControl: function ( btn, e )
		{
			...
			{	
				...
				{	
                    ...
                    a.addWithPopup(b, "Pricing table", "pricing_table" );
                    ...
                    c=b.addMenu({title: "Buddypress"});
                        ...
                        a.addWithPopup(c, "Vertical Search form", "search_members_horizontal" );
                        a.addImmediate(c, "Total members number", "[kleo_total_members]" );
                        a.addImmediate(c, "Online members number", "[kleo_members_online]" );
                        a.addImmediate(c, "Online Women number", "[kleo_women_online]" );
                        a.addImmediate(c, "Online Men number", "[kleo_men_online]" );
