...
class Kleo_Options_bg {
    ...
    */
    function render() {
        ...
        $type_opts = array('pattern' => 'Pattern', 'image' => 'Image', 'color' => 'Color');
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="squeen-opts-upload button-secondary"' . $upload . ' rel-id="image_' . $this->field['id'] . '">' . __('Upload', 'kleo_framework') . '</a>';
        ...
        echo ' <a href="javascript:void(0);" class="squeen-opts-upload-remove"' . $remove . ' rel-id="image_' . $this->field['id'] . '">' . __('Remove', 'kleo_framework') . '</a>';
        echo '<br><br>';
