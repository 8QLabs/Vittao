			...
			<td colspan="6" class="actions">
				...
				<?php if ( $woocommerce->cart->coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<label for="coupon_code"><?php _e( 'Coupon', 'woocommerce' ); ?>:</label> <input name="coupon_code" class="input-text" id="coupon_code" value="" /> <input type="submit" class="button small" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
				...
				<input type="submit" class="button small" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /> <input type="submit" class="checkout-button button small alt" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" />
