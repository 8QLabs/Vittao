		...
		<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
			...
			<div<?php bp_field_css_class( 'editfield' ); ?>>
				...
				<?php if ( 'selectbox' == bp_get_the_profile_field_type() ) : ?>
					...
					<label for="<?php bp_the_profile_field_input_name(); ?>"><?php bp_the_profile_field_name(); ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(required)', 'buddypress' ); ?><?php endif; ?></label>
					<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>" id="<?php bp_the_profile_field_input_name(); ?>" <?php if ( bp_get_the_profile_field_is_required() ) : ?>aria-required="true"<?php endif; ?>>
				...
				<?php if ( 'multiselectbox' == bp_get_the_profile_field_type() ) : ?>
					...
					<label for="<?php bp_the_profile_field_input_name(); ?>"><?php bp_the_profile_field_name(); ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(required)', 'buddypress' ); ?><?php endif; ?></label>
					<select data-customforms="disabled" class="expand" name="<?php bp_the_profile_field_input_name(); ?>" id="<?php bp_the_profile_field_input_name(); ?>" multiple="multiple" <?php if ( bp_get_the_profile_field_is_required() ) : ?>aria-required="true"<?php endif; ?>>
				...
				<?php if ( 'datebox' == bp_get_the_profile_field_type() ) : ?>
						...
						<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>_day" id="<?php bp_the_profile_field_input_name(); ?>_day" <?php if ( bp_get_the_profile_field_is_required() ) : ?>aria-required="true"<?php endif; ?>>
							...
							<?php bp_the_profile_field_options( 'type=day' ); ?>
                                                ...
                                                <div class="four columns">
						<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>_month" id="<?php bp_the_profile_field_input_name(); ?>_month" <?php if ( bp_get_the_profile_field_is_required() ) : ?>aria-required="true"<?php endif; ?>>
							...
							<?php bp_the_profile_field_options( 'type=month' ); ?>
                                                ...
                                                <div class="four columns">
						<select class="expand" name="<?php bp_the_profile_field_input_name(); ?>_year" id="<?php bp_the_profile_field_input_name(); ?>_year" <?php if ( bp_get_the_profile_field_is_required() ) : ?>aria-required="true"<?php endif; ?>>
