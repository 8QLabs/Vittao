<div id="register_panel" class="reveal-modal">
  <div class="row">
    <div class="twelve columns">
      ...
      <div class="twelve columns">
          <p><small><?php _e("Check our", 'kleo_framework');?> <a target="_blank" href="<?php if( sq_option('terms_page', '#') != "#") echo get_permalink(sq_option('terms_page')); else echo '#'; ?>"><strong><?php _e("terms and conditions", 'kleo_framework');?></strong></a> <?php _e("before sign up. If you familiar with our terms, go ahead click CREATE MY ACCOUNT button.", 'kleo_framework');?></small></p>
