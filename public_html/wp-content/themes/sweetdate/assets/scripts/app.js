...
function hyperlinkPhone(){
	 jQuery("a[href^='tel:']").click(function(){
	 	if( !jQuery("body").hasClass("mobile") )  return false;
  });
}
...
/***************************************************
2. CarouFredSel - Responsive Carousel  -moved to shortcodes and homepage
***************************************************/
...
function toggleForm(){
	...
	jQuery('.show-form').toggle(
		function(){
			jQuery('.leave-message').stop(true).slideDown();
		},
		function(){
			jQuery('.leave-message').stop(true).slideUp();
		}
	);
}
