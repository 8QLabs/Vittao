...
get_header( 'buddypress' ); ?>
		...
		<form action="" method="post" id="groups-directory-form" class="dir-form custom">
			...
			<h2 style="display: inline;"><?php _e( 'Groups Directory', 'buddypress' ); ?><?php if ( is_user_logged_in() && bp_user_can_create_groups() ) : ?><?php endif; ?></h2> &nbsp;<a style="display:inline-block;" class="button radius small" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() . '/create' ); ?>"><?php _e( 'Create a Group', 'buddypress' ); ?></a>
