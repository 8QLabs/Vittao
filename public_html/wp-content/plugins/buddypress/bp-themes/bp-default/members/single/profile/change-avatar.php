	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<?php if ( bp_get_user_has_avatar() ) : ?>
				...
				<p><a class="button edit" href="<?php bp_avatar_delete_link(); ?>" title="<?php _e( 'Delete Picture', 'buddypress' ); ?>"><?php _e( 'Delete My Picture', 'buddypress' ); ?></a></p>
			<?php endif; ?>
		...
		<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<div id="avatar-crop-pane">
				<img src="<?php bp_avatar_to_crop(); ?>" id="avatar-crop-preview" class="avatar" alt="<?php _e( 'Picture preview', 'buddypress' ); ?>" />
			</div>
...
<?php else : ?>
	...
	<p><?php _e( 'Your picture will be used for your profile.', 'buddypress' ); ?></p>
