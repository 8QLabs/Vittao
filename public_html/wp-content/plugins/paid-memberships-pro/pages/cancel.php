...
<p class="strong"><?php _e('Are you sure you want to cancel your membership?', 'pmpro');?></p>

<p>
	<a class="pmpro_yeslink yeslink small radius button secondary" href="<?php echo pmpro_url("cancel", "?confirm=true")?>"><?php _e('Yes, cancel my membership', 'pmpro');?></a>
	-
