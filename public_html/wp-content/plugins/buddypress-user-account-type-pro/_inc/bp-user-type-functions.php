...
function buatp_get_type_directory_slug($type){
    ...
    if($buatp_general_settings['buatp_slug_selection_for_'.$type])
        return $buatp_general_settings['buatp_slug_selection_for_'.$type];
    else
