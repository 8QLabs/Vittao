...
The Vidtok Plugin requires that you have your permalinks settings set to anything except DEFAULT, the default settings will cause the plugin to fail. To update your permalinks settings, click on the settings tab, then click on permalinks. Change your settings from default to anything you would like.
