			  ...
			  /*Vidtok Video Share*/
				  jQuery('#vidtok-submit').click(function(){
					  ...
					  /*Variables*/
							...
							var url		= '<?php echo str_replace('broadcaster', 'viewer', $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"]); ?>';
...
<body>
    ...
    <!--VIDTOK SHARE LINK-->
		<div class="vidtok-share-w" id="vidtok-share-panel">
            ...
            <script>function fbs_click() { u=location.href; t=document.title; window.open('http://www.facebook.com/sharer.php?u='+encodeURIComponent('<?php echo str_replace('broadcaster', 'viewer', $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"]); ?>')+'&t='+encodeURIComponent(t),'sharer','toolbar=0,status=0,width=500,height=360');return false;}</script>
            ...
            <script>function tw_click() { u=location.href; t=document.title; window.open('http://twitter.com/intent/tweet?text=<?php echo urlencode('Join our Vidtok video chat! '.str_replace('broadcaster', 'viewer', $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"])); ?>','sharer','toolbar=0,status=0,width=500,height=360');return false;}</script>
