...
<meta charset="utf-8">
    ...
    <!--VIDTOK OPTIONS-->
        ...
        <?php 
			...
			/*QUERY*/				
				$query = 'select * from ' . $wpdb->get_blog_prefix() . "vidtok_archive WHERE deleted = 'no'"; 
				
				$archives = $wpdb->get_results($wpdb->prepare($query)); 
			...
			/*CREATE TOKEN*/
				...
				$token = $apiObj->generateToken($vidtok->opentok_session_id, RoleConstants::MODERATOR);
